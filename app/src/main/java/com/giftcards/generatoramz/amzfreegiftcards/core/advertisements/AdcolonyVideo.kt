...
class AdcolonyVideo {
    ...
    fun init(activity: Activity) {
        AdColony.configure(activity, "app6df1038d3315413c82", "vz371f2caf54c84ae2bd")
    ...
    fun onResume(activity: Activity) {
        if (adcolonyVideo == null || adcolonyVideo!!.isExpired) {
            AdColony.requestInterstitial("vz371f2caf54c84ae2bd",
                ...
                override fun onExpiring(ad: AdColonyInterstitial?) {
                    super.onExpiring(ad)
                    AdColony.requestInterstitial("vz371f2caf54c84ae2bd", this)
                }
            })
        }
    }
