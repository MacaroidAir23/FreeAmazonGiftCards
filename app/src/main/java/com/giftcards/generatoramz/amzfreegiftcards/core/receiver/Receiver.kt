package com.giftcards.generatoramz.amzfreegiftcards.core.receiver
...
import com.giftcards.generatoramz.amzfreegiftcards.screens.OffersActivity
...
class Receiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (prefs.get(PreferencesManager.FIRST_LAUNCH, false)) {
            ...
            var ni = Intent(context, OffersActivity::class.java)
